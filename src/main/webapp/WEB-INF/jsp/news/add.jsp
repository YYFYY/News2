	    		...
	    		<tr>
	    			...
	    			<td>
	    				<textarea id="add-content" name="content"  style="width:760px;height:300px;" ><%-- <%
	 							response.sendRedirect("/resources/admin/ueditor/index.html");
 							%> --%> 
 			<%-- <jsp:include page="/resources/admin/ueditor/index.jsp"></jsp:include> --%><%-- <%@ include  file="/resources/admin/ueditor/index.jsp"%> --%>
 							<!-- <iframe src="/resources/admin/ueditor/index.html" ></iframe> -->
 							</textarea>
...
<div id="preview-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:330px; padding:10px;">
        <table>
            <tr>
                <td><img id="preview-photo" src="/SSM_NewsBlog/resources/upload/news-pic.jpg" width="300px"></td>
            </tr>
        </table>
</div>
<!-- 上传图片进度条 -->
...
<script type="text/javascript">
        ...
        UE.Editor.prototype.getActionUrl = function(action) {
            if (action == 'uploadimage' || action == 'uploadscrawl' || action == 'uploadimage') {
                return 'http://148.70.102.57/ueditor/imgUpload';
