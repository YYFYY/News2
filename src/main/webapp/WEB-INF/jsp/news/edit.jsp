...
<div class="easyui-panel" title="修改新闻页面" iconCls="icon-add" fit="true" >
		<div style="padding:10px 60px 20px 60px">
	    <form id="add-form" method="post">
	    	<table cellpadding="5">
	    	
	    		<tr>
	    			<td>新闻标题:<input type="hidden" name="id" value="${news.id }"></input></td>
	    		...
	    		<tr>
	    			<td>新闻内容:</td>
	    			<td>
	    				<textarea id="add-content" name="content"  style="width:760px;height:300px;">${news.content }</textarea>
	    			</td>
	    		</tr>
	    	</table>
	    </form>
