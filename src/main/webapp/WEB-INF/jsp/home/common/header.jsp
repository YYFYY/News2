...
<link rel="shortcut icon" href="../resources/home/images/yyf_icon2.png">
...
<div class="container">
  <div class="header-topbar hidden-xs link-border">
	<ul class="site-nav topmenu">
	  <!-- <li><a href="#" >标签云</a></li> -->
		<li><a href="${pageContext.request.contextPath }/system/login" rel="nofollow" >后台</a></li>
		<li><a href="#" title="收藏" onclick="addFavorite('http://localhost:8080/SSM_NewsBlog/index/index','阳凡')">
			<i class="fa fa-rss">
			</i> 收藏
		</a></li>
	</ul>
  ...
  <div class="navbar-header">
	...
	<h1 class="logo hvr-bounce-in"><a href="#" title="阳凡新闻博客"><img src="../resources/home/images/yy.jpg" alt="阳凡新闻博客"></a></h1>
  </div>
  <div class="collapse navbar-collapse" id="header-navbar">
	<form class="navbar-form visible-xs" action="../news/search_list" method="post">
	...
	<ul class="nav navbar-nav navbar-right">
	  <li><a data-cont="阳凡新闻博客" title="阳凡新闻博客" href="${pageContext.request.contextPath }/index/index">首页</a></li>
